 ...
 while mass_frac < mass_frac_out
        ...
        i = 2;
        area = 3.14*D*step_size*num_tubes; % m^2
    ...
    tubes_per_filter = 100;
    num_filters = num_tubes/tubes_per_filter;
    
    area_tot = num_tubes*2.5*3.14159*D
    n = 0.8;
    P = 15924.28;
    cost_per = P*(area_tot/1000)^n;
    cost_tot = cost_per*area_tot
